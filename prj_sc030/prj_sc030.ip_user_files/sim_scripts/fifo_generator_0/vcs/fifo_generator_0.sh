...
#
# Generated by Vivado on Thu Feb 28 11:17:07 +0800 2019
...
# Script info
echo -e "fifo_generator_0.sh - Script generated by export_simulation (Vivado v2018.1 (64-bit)-id)\n"
...
compile()
{
  ...
  vlogan -work fifo_generator_v13_2_2 $vlogan_opts +v2k +incdir+"D:/Xilinx/Vivado/2018.1/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"D:/Xilinx/Vivado/2018.1/data/xilinx_vip/include" \
    "$ref_dir/../../../../prj_sc030.srcs/sources_1/ip/fifo_generator_0/sim/fifo_generator_0.v" \
  2>&1 | tee -a vlogan.log
